...
const I18N = {
  ...
  ur: {
    'nav.globe': 'دنیا',
    'nav.solutions': 'راستہ',
    'globe.label': 'کرہ ارض پر یہ نظام',
    'globe.title': 'دنیا کو گھمائیں۔ ڈالر اور تیل کے بہاؤ کو دیکھیں۔',
    'globe.lede': 'پیٹروڈالر نظام کوئی تجریدی خیال نہیں — یہ حقیقی جغرافیہ پر چلتا ہے۔ امریکہ ڈالر چھاپتا ہے، بھارت جیسے درآمد کنندگان تیل کے لیے ڈالر ادا کرتے ہیں، اور خلیجی برآمد کنندگان اس اضافی رقم کو امریکی ٹریژری میں واپس ڈال دیتے ہیں۔ گلوب گھمائیں اور زوم کریں، پھر کسی بھی ملک پر ٹیپ کر کے دیکھیں کہ وہ اس مشین میں کہاں بیٹھتا ہے۔',
    'globe.note': 'ممالک کے نشان تخمینی دارالحکومتوں پر رکھے گئے ہیں۔ اعداد و شمار اسی صفحے پر استعمال ہونے والا 14 مئی 2026 کا اسنیپ شاٹ ہیں اور ہر ملک کے کردار کو ظاہر کرنے کے لیے ہیں، لائیو ڈیٹا نہیں۔',
    'sol.label': 'راستہ',
    'sol.title': 'روپیہ پھنسا ہوا ہے — مگر بے بس نہیں۔ لیور منتخب کریں۔',
    'sol.lede': 'تشخیص کہانی کا صرف آدھا حصہ ہے۔ بھارت جو پالیسی اور ڈھانچہ جاتی اقدامات واقعی کر سکتا ہے، انہیں ٹوگل کریں — ہر ایک حقیقی ہے، کسی نہ کسی شکل میں پہلے سے جاری — اور دیکھیں کہ وہ روپے کو ₹95.96 سے کتنا پیچھے کھینچ سکتے ہیں۔ کوئی ایک لیور اکیلا اسے ٹھیک نہیں کرتا۔ مل کر، یہ جمع ہو جاتے ہیں۔',
    'nav.puzzle': 'معمہ',
    'nav.timeline': 'ٹائم لائن',
    'nav.printing': 'ڈالر کی چھپائی',
    'nav.system': 'نظام',
    'nav.forces': 'قوتیں',
    'nav.simulator': 'سیمولیٹر',
    'nav.currencies': 'کرنسیاں',
    'nav.impact': 'اثر',
    'nav.data': 'ڈیٹا',
    'hero.date': '14 مئی، 2026',
    'hero.sub': 'ڈالر کے مقابلے میں ہمہ وقتی کم ترین سطح',
    'hero.puzzleLabel': 'معمہ',
    'hero.puzzle': 'امریکہ دہائیوں سے ڈالر چھاپ رہا ہے۔<br>تو پھر روپیہ کیوں گر رہا ہے، ڈالر کیوں نہیں؟',
    'hero.cta': 'کہانی پڑھیں',
    'puzzle.label': 'فطری اندازہ ناکام ہو جاتا ہے',
    'puzzle.title': 'دنیا میں زیادہ ڈالر کا مطلب سستا ڈالر ہونا چاہیے۔',
    'puzzle.lede': 'کسی بھی عام کرنسی کے لیے بالکل یہی ہوتا ہے۔ لیکن ڈالر عام نہیں۔ یہ دنیا کا پائپ نظام ہے — اور جب دنیا پریشان ہوتی ہے، ہر درآمد کنندہ ملک کو فیڈ کے چھاپنے سے زیادہ تیزی سے مزید ڈالر چاہیے ہوتے ہیں۔',
    'timeline.label': '26 سال، دو لکیریں',
    'timeline.title': 'امریکہ نے چھاپا۔ روپیہ گرا۔ وہ ساتھ چلے — الگ نہیں۔',
    'printing.label': 'ڈالر کی چھپائی کیسے کام کرتی ہے',
    'printing.title': 'فیڈ جب "چھاپتا" ہے تو وہ اصل چھاپہ خانے نہیں چلاتا۔',
    'printing.lede': 'ڈالر کی رسد بینکنگ نظام کے ذریعے بڑھتی ہے — اور یہ کیسے بڑھتی ہے یہ طے کرتا ہے کہ روپے کو تقویت ملتی ہے یا مار۔',
    'system.label': 'نظام',
    'system.title': 'معمہ تین تہوں میں حل ہوتا ہے۔',
    'forces.label': 'چار قوتیں',
    'forces.title': 'ہر ڈالر طلب کا بہاؤ بیک وقت فعال ہے۔',
    'forces.lede': 'کوئی ایک عنصر اس گراوٹ کی وضاحت نہیں کرتا۔ 2026 میں چار قوتیں ایک دوسرے پر جمع ہو رہی ہیں — اور روپے کے پاس چھپنے کی جگہ نہیں۔',
    'sim.label': 'ویلیو سیمولیٹر',
    'sim.title': 'سلائیڈر ہلائیں۔ روپے کا ردعمل دیکھیں۔',
    'sim.lede': 'پانچ بڑی قوتوں کا سادہ لکیری ماڈل — تیل، ڈالر کی طاقت، سرمائے کا بہاؤ، فیڈ پالیسی اور آر بی آئی دفاع۔ کوئی بھی ان پٹ بدلیں، متوقع USD/INR فوراً اپ ڈیٹ ہوتا ہے۔',
    'ccy.label': 'بین الکرنسی اثر',
    'ccy.title': 'بھارت اکیلا نہیں۔ ڈالر سب کو ہلا رہا ہے۔',
    'ccy.lede': 'نیچے کوئی بھی کرنسی چنیں اور دیکھیں کہ روپے کو متاثر کرنے والی انہی قوتوں کا وہ کیسے جواب دیتی ہے — کچھ کیوں ٹکی ہوئی ہیں اور کچھ کیوں ٹوٹ رہی ہیں۔',
    'impact.label': 'اثر کی زنجیر',
    'impact.title': 'روپے کی کمزوری آپ کی جیب تک کیسے پہنچتی ہے۔',
    'impact.lede': 'کمزور روپیہ تین اول درجے کے اثرات پیدا کرتا ہے — اور ہر ایک اس چیز میں بدلتا ہے جو گھرانہ، فرم یا مرکزی بینک براہ راست محسوس کرتا ہے۔',
    'ref.label': 'حوالہ جات اور ڈیٹا',
    'ref.title': 'اعداد، اور وہ کہاں سے آتے ہیں۔',
    'ref.lede': 'اس صفحے پر درج ہر عدد، اس کے ماخذ اور آخری تصدیق کی تاریخ کے ساتھ۔ ڈیٹا وقت کا ایک اسنیپ شاٹ ہے — شرح مبادلہ اور منافع ہر منٹ بدلتے ہیں۔',
    'math.label': 'بنیادی حساب',
    'math.title': 'اندازے کے پیچھے فارمولا دیکھیں۔',
    'math.lede': 'ہر سلائیڈر کا ایک عددی سر ہے۔ آج کی بنیاد گھٹائیں۔ ضرب دیں۔ جمع کریں۔ یہی ماڈل ہے — کوئی چھپے مراحل نہیں۔',
    'math.formula': 'متوقع ₹/$ = ₹95.96 + Σ ( عددی سر × (موجودہ قدر − بنیاد) )',
    'math.amount': 'ایک رقم تبدیل کریں',
    'math.amountHelp': 'دیکھیں $1,000 آج کتنے کے اور سیمولیٹڈ شرح پر کتنے کے۔',
    'math.usd': 'ڈالر (USD)',
    'math.inrToday': 'آج کے ₹95.96 پر',
    'math.inrSim': 'سیمولیٹڈ شرح پر',
    'math.diff': 'فرق',
    'math.cheaper': 'سستا',
    'math.costlier': 'مہنگا',
    'math.flat': 'آج جیسا ہی',
  },
};
